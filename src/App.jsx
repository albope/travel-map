...
// Components & Pages (Mantenemos tus imports)
...
// Componente NavLink personalizado para detectar ruta activa
        ...
        <header className="fixed top-4 left-0 right-0 z-50 px-4 md:px-0">
          <nav className="container mx-auto max-w-5xl bg-surface/80 backdrop-blur-md border border-white/20 shadow-soft rounded-2xl px-6 py-3 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link to="/" className="bg-text-main text-white px-5 py-2 rounded-full text-sm font-semibold shadow-lg hover:bg-black hover:shadow-xl transition-all transform hover:-translate-y-0.5">
                Empezar
              </Link>
            </div>
